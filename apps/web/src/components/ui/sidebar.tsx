...
function SidebarProvider({
  ...
  }, [isMobile, setOpen, setOpenMobile, variant]);
    ...
    >
      ...
      >
        <div
          ...
          className="bg-[#151515] rounded-r-2xl shadow-[inset_0_-1px_1px_0_rgba(30,30,30,0.2),inset_0_1px_1px_0_rgba(255,255,255,0.2)] flex h-full w-full flex-col justify-center items-center px-3 py-4 group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm"
        >
          {children}
        </div>
      </div>
...
function SidebarMenu({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
      ...
      data-sidebar="menu"
      className={cn(
        "flex w-full min-w-0 flex-col gap-2 items-center",
        className,
      )}
      {...props}
    />

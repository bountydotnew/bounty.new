export function Stripe(props: React.HTMLAttributes<SVGElement>) {
  return (
    <svg viewBox="0 0 468 222.5" xmlns="http://www.w3.org/2000/svg" {...props}>
      <title>Stripe</title>
      <path
        className="st0"
      ...
      />
      <rect className="st0" height="87.5" width="25.1" x="223.8" y="69.3" />
      <path
        className="st0"

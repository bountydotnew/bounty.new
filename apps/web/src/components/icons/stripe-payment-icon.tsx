export function StripePaymentIcon({ className }: { className?: string }) {
  ...
  return (
    <div className="absolute top-[-70px] w-[70px] h-[95px] shrink-0 overflow-hidden rounded-[6px] bg-white p-2">
      ...
      <div className="h-[20px] rounded-[3px] border border-[#E5E5E5] mb-1 flex items-center px-2">
        <div className="w-[20px] h-[6px] rounded-full bg-[#151B2533]" />
        <div className="w-[40px] h-[6px] rounded-full bg-[#151B2533] ml-2" />
      </div>
      
      {/* Card details section */}
      <div className="h-[30px] rounded-[3px] border border-[#E5E5E5] mb-1 p-1 flex flex-col gap-1">
        <div className="flex items-center gap-1">
          <div className="w-[8px] h-[8px] rounded-full bg-[#151B2533]" />
          <div className="w-[25px] h-[4px] rounded-full bg-[#151B2533]" />
        </div>
        <div className="flex items-center gap-1">
          <div className="w-[8px] h-[8px] rounded-full bg-[#151B2533]" />
          <div className="w-[20px] h-[4px] rounded-full bg-[#151B2533]" />
        </div>
      </div>

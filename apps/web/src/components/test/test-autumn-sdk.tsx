  ...
  const handleAttach = async () => {
    ...
    try {
      ...
      if (result.error) {
        ...
        // If checkout URL returned, navigate to it
    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center gap-2">
            {error ? (
              ...
              <>
                ...
                <span className="text-green-500">SDK Connected - Customer loaded</span>
              </>
            ) : isLoading ? (
              <>
              ...
              <>
                ...
                <span className="text-yellow-500">No customer found - complete checkout to create one</span>
              </>
            )}
          </div>
          ...
          {customer && (
            <div className="rounded-lg bg-muted p-4 space-y-2 text-sm">
              <div className="flex items-center justify-between">
                ...
                <code className="rounded bg-background px-2 py-1 text-xs">{customer.id ?? 'N/A'}</code>
              </div>
              <div className="flex items-center justify-between">
          ...
          {/* Features */}
          {customer && customer.features && Object.keys(customer.features).length > 0 && (
            <div className="space-y-2">
              <Label>Features</Label>
              <div className="space-y-2">
                {Object.entries(customer.features).map(([key, feature]: [string, any]) => (
                  <div key={key} className="rounded-lg border p-3">
                    ...
                    <div className="mt-2 grid grid-cols-2 gap-2 text-sm text-muted-foreground">
                      ...
                      {feature.unlimited && <div className="col-span-2">Unlimited</div>}
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="rounded-lg border p-4">
              {attachResult.error ? (
                ...
                <div className="space-y-2">
                  ...
                  {'checkout_url' in attachResult.data && attachResult.data.checkout_url ? (
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="flex gap-2">
            ...
            <div className="flex items-end">
              <Button onClick={handleTrack} disabled={!customer} variant="outline">
                Track Usage (+1)
              </Button>
            </div>
          </div>

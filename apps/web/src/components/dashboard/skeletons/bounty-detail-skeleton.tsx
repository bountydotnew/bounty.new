        ...
        <div className="flex flex-col gap-8 xl:flex-row">
          <div className="flex-1 p-8 xl:flex-[2]">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3 rounded-lg border border-[#383838]/20 bg-[#1D1D1D] p-4">
          ...
          <div className="hidden xl:block xl:w-[480px] xl:flex-shrink-0">
            <div className="sticky top-0 xl:h-[calc(100vh-8rem)] xl:overflow-y-auto xl:pr-2">
              ...
              <div className="space-y-4">
                <div className="rounded-lg border border-[#383838]/20 bg-[#1D1D1D] p-4">
                  ...
                  <div className="mb-3 h-20 w-20 rounded bg-[#383838]/20" />

    ...
    <div className="flex flex-col items-center justify-center py-24 px-6">
      ...
      <div className="relative mb-8">
        ...
        <div className="relative">
          {/* Outer ring */}
          <div className="w-24 h-24 rounded-2xl border border-dashed border-border-default flex items-center justify-center bg-background/50">
            {/* Bookmark shape */}
            <svg
              width="36"
              height="44"
      ...
      <div className="text-center max-w-xs">
        <h3 className="text-[15px] font-medium text-text-secondary mb-2">
          No bookmarks yet
        </h3>
        ...
        <Link
          href="/dashboard"
          className="inline-flex items-center gap-2 px-4 py-2 text-[13px] text-text-muted hover:text-foreground rounded-lg border border-border-default hover:border-border-strong bg-surface-1 hover:bg-surface-2 transition-all duration-200"
        >
          <svg
            viewBox="0 0 16 16"
            fill="currentColor"

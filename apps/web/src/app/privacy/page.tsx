              ...
              <div className="prose prose-invert prose-lg max-w-none prose-headings:font-display prose-headings:tracking-tight prose-headings:text-foreground prose-h2:text-2xl prose-h2:mt-12 prose-h2:mb-4 prose-h3:text-xl prose-h3:mt-8 prose-h3:mb-3 prose-p:text-text-secondary prose-p:leading-[1.8] prose-a:text-foreground prose-a:underline prose-a:decoration-border-subtle hover:prose-a:decoration-foreground prose-strong:text-foreground prose-ul:text-text-secondary prose-li:text-text-secondary prose-li:leading-[1.8] prose-hr:border-border-subtle">
                <section id="commitment">
                  ...
                  <p>
                    ...
                    your data. This policy explains what we collect and why.
                  </p>
                </section>
                ...
                <section id="collection">
                  ...
                  <ul>
                    ...
                    <li>
                      <strong>Profile picture:</strong> If you upload one, or
                      use a social login that provides one
                    </li>
                    <li>
                      <strong>Authentication data:</strong> Password (hashed -
                      we can't see it) or OAuth tokens if you use social login
                    </li>
                  </ul>
                  ...
                  <p>
                    Payment processing is handled by <strong>Stripe</strong>. We
                    do not store your full credit card number, CVV, or other
                    sensitive payment details on our servers. Stripe handles all
                    of that securely.
                  </p>
                  ...
                  <p>
                    We use privacy-focused analytics (Databuddy) to understand
                    how people use the platform. This is GDPR compliant and
                    collects:
                  </p>
                  <ul>
                    ...
                    <li>
                      General geographic region (country-level, not precise
                      location)
                    </li>
                  </ul>
                  <p>
                    We don't track individual user behavior across sessions or
                ...
                <section id="usage">
                  ...
                  <p>
                    We <strong>don't</strong> sell your data to advertisers or
                    data brokers.
                  </p>
                </section>
                ...
                <section id="storage">
                  ...
                  <p>
                    Data stored in the <strong>United States</strong> on secure
                    cloud infrastructure. Encrypted in transit (TLS) and at
                    rest. Access limited to authorized team members.
                  </p>
                </section>
                ...
                <section id="visibility">
                  ...
                  <p>
                    <strong>We can see:</strong> Profile info, bounties,
                    submissions, comments, transaction history.
                  </p>
                  <p>
                    <strong>We cannot see:</strong> Your password (hashed), full
                    card details (Stripe handles that).
                  </p>
                  <p>
                    We only access user data for support, investigating abuse,
                    debugging issues, or legal requirements.
                  </p>
                </section>
                ...
                <section id="sharing">
                  ...
                  <ul>
                    <li>
                      <strong>Public info:</strong> Profile, bounties,
                      submissions are visible to other users
                    </li>
                    <li>
                      <strong>Service providers:</strong> Only what's needed to
                      operate (payment, hosting, etc.)
                    </li>
                    <li>
                      <strong>Legal:</strong> If required by law
                    </li>
                    <li>
                      <strong>Business transfers:</strong> If acquired, data may
                      transfer (you'd be notified)
                    </li>
                  </ul>
                  <p>
                ...
                <section id="rights">
                  ...
                  <ul>
                    ...
                    <li>
                      <strong>Correct:</strong> Update inaccurate info in
                      settings
                    </li>
                    <li>
                ...
                <section id="retention">
                  ...
                  <p>
                    Active accounts: data retained while account exists. Deleted
                    accounts: data removed within 30 days (backups may briefly
                    retain data).
                  </p>
                  <p>
                    Transaction records kept for tax/legal purposes. Banned
                    account info retained to prevent re-registration.
                  </p>
                </section>
                ...
                <section id="cookies">
                  <h2>Cookies</h2>
                  <p>
                    We use cookies and similar technologies. Here's what they
                    do:
                  </p>

                  <h3>Essential Cookies</h3>
                  <p>
                    Required for the site to function. These handle things like
                    keeping you logged in and remembering your preferences. You
                    can't opt out of these without breaking the site.
                  </p>

                  <h3>Analytics Cookies</h3>
                  <p>
                    Help us understand how people use the platform. We try to
                    use privacy-friendly analytics that don't track you across
                    the web. You can opt out of these.
                  </p>

                  <h3>Preference Cookies</h3>
                  <p>
                    Remember your settings, like dark mode or language
                    preferences.
                  </p>

                  <h3>Managing Cookies</h3>
                  <p>
                    Your browser lets you control cookies. You can block or
                    delete them, but this may affect how bounty.new works for
                    you.
                  </p>
                </section>
                ...
                <section id="security">
                  ...
                  <p>
                    That said, no system is 100% secure. We can't guarantee
                    absolute security, so please:
                  </p>
                  <ul>
                ...
                <section id="changes">
                  ...
                  <ul>
                    ...
                    <li>
                      We'll keep previous versions available if you want to see
                      what changed
                    </li>
                  </ul>
                  <p>
                    Continued use of bounty.new after changes means you accept
                    the updated policy. If you don't agree with changes, you can
                    delete your account.
                  </p>
                </section>
                ...
                <section id="contact">
                  <h2>Contact Us</h2>
                  <p>
                    Questions, concerns, or requests about your privacy? We're
                    here to help.
                  </p>
                  <p>
                    <strong>Email:</strong>{' '}
                  ...
                  <p>
                    We aim to respond within a few business days. For data
                    requests, please allow up to 30 days.
                  </p>
                  <p>
                    Thanks for trusting bounty.new with your information. We

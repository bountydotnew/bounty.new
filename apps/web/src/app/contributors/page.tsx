              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-white/60">
                    Open-source bounties, built in public
                  </div>
                </div>
              </div>
    ...
    <div className="group relative overflow-hidden rounded-xl border border-white/10 bg-white/[0.03] p-4 transition-transform duration-200 hover:-translate-y-0.5">
      ...
      <div className="relative flex items-center gap-3">
        ...
        <Link
          href={c.html_url}
          target="_blank"
          className="grid place-items-center rounded-md border border-white/10 bg-white/5 p-2 text-sm hover:bg-white/10 transition-colors"
        >
...
export default function ContributorsPage() {
  ...
  useEffect(() => {
    ...
    const last7 = Array.from({ length: 7 }, (_, i) => {
      ...
      const commits = safeCommits.filter(
        ...
        <div className="container mx-auto px-6">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {core.map((c) => (
                  <CoreCard
                    key={c.login}
                    c={c}
                    role={c.login === "ripgrim" ? "Founder" : undefined}
                  />
                ))}
              </div>
            </div>
                ...
                <ResponsiveContainer width="100%" height={300}>
                  ...
                  >
                    ...
                    <Tooltip
                      ...
                      formatter={(v) => [`${v} commits`, "Activity"]}
                    />
                    <defs>
          ...
          <div className="mt-12 flex items-center justify-center">
            <Link
              ...
              target="_blank"
              className="inline-flex items-center gap-2 rounded-lg border border-white/10 bg-white/5 px-4 py-2 text-sm hover:bg-white/10 transition-colors"
            >
              <Github className="w-4 h-4" />

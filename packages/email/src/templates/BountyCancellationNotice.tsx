  ...
  return (
    <BaseEmail
      ...
      footerNote={
        <>
          ...
          <Link href="mailto:grim@bounty.new" className="text-[#26251E] underline">
            grim@bounty.new
          </Link>
        </>
      }
    >
      <Text className="text-[14px] leading-[1.6] text-[rgba(38,37,30,0.6)] m-0 mb-[12px]">
        ...
        {reason ? ` has requested to cancel a bounty you're working on:` : ' has cancelled a bounty you were working on:'}
      </Text>
      ...
      <Text className="text-[14px] leading-[1.6] text-[rgba(38,37,30,0.6)] m-0 mb-[12px]">
        This means your submission may no longer be reviewed. If the cancellation
        is approved, the bounty will be closed and no payouts will be made.
      </Text>

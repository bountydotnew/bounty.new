 ...
 */
const AlphaAccessGranted = ({
	name = "there",
	token,
}: AlphaAccessGrantedProps) => {
	const href = token
	...
	return (
		...
		>
			...
			<Text className="text-[14px] leading-[1.6] text-[rgba(38,37,30,0.6)] m-0 mb-[12px]">
				I'm excited to have you test the future of bounty collaboration. Create
				your first bounty, find contributors, and ship faster.
			</Text>

			<Text className="text-[14px] leading-[1.6] text-[rgba(38,37,30,0.6)] m-0 mb-[12px]">
				This is early days, so things might be a little rough around the edges.
				I'd love your feedback as I build this out.
			</Text>

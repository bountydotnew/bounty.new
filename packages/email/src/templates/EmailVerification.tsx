    ...
    <BaseEmail
      ...
      footerNote={
        <>
          ...
          account with {email}, you can safely ignore this email.
        </>
      }
    >
      ...
      <Text className="text-[14px] leading-[1.6] text-[rgba(38,37,30,0.6)] m-0 mb-[12px]">
        To complete your registration and start using your account, please verify
        your email address by clicking the button below:
      </Text>

      <Text className="text-[14px] leading-[1.6] text-[rgba(38,37,30,0.6)] m-0 mb-[12px]">
        If you're having trouble with the button above, you can also copy and paste

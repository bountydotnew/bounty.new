    ...
    const mockNews = [
      {
        ...
        summary:
          "A revolutionary platform connecting developers with rewarding opportunities through bounties.",
        image: "/og-image.png",
      },
      {
        ...
        summary:
          "Discover the most active developers who completed bounties and earned rewards.",
      ...
      },
      {
        ...
        summary:
          "Learn how to post your first bounty and start getting help from the community.",
      ...
      },
      {
        ...
        summary:
          "Latest features and improvements to the bounty platform experience.",
        image: "/og-image.png",
      },
      {
        ...
        summary:
          "Join the waitlist to get early access to new features and premium tools.",
